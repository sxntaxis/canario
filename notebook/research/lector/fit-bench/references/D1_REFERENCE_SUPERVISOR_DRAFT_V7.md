---
id: CANARIO-LECTOR-FIT-BENCH-D1-REFERENCE-SUPERVISOR-DRAFT-007
kind: benchmark-reference-candidate
state: supervisor-draft
fixture: CR-ESPARZA-MINUTES-001
---

# D1 supervisor reference draft v7

D1 v7 is the supervising-author revision after the blind senary semantic audit of v6. The senary audit returned `REFERENCE_DISPUTE` with 22 hard groups; all 22 were source-reopened and accepted.
